...
# --- ส่วนตั้งค่าหลัก ---
# URL สำหรับดึงข้อมูล (อาจต้องอัปเดตหากเว็บมีการเปลี่ยนแปลง)
# C.35 อินทร์บุรี
INBURI_URL = "http://watertele.rid.go.th/tele/lpbr_tele/report_hist.php?id=35"
# C.2 นครสวรรค์ (สำหรับดูแนวโน้ม)
NAKHONSAWAN_URL = "http://watertele.rid.go.th/tele/nkswn_tele/report_hist.php?id=2"
# เขื่อนเจ้าพระยา
CHAO_PHRAYA_DAM_URL = "https://watertele.rid.go.th/tele/dam/report_hist_dam.php?id=1"

# กุญแจสำหรับส่ง LINE (จะดึงมาจาก GitHub Secrets)
...
def get_water_data(url):
    ...
    try:
        ...
        # ค้นหาข้อมูลจากตารางในหน้าเว็บ (โค้ดส่วนนี้อาจต้องปรับแก้หากโครงสร้างเว็บเปลี่ยน)
        # เราจะมองหาแถวสุดท้าย (ข้อมูลล่าสุด) ของตาราง
        last_row = response.text.split('</TR>')[-2]
        columns = last_row.split('</TD>')
        
        # ดึงข้อมูลจากคอลัมน์ที่ถูกต้อง (อาจต้องปรับเลข index)
...
def get_dam_data(url):
    ...
    try:
        ...
        # ดึงข้อมูลการระบายน้ำ (มักจะอยู่คอลัมน์ท้ายๆ)
...
# --- ส่วนที่ 3: ฟังก์ชันส่งข้อความไปที่ LINE ---
